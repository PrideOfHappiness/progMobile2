...
import com.example.proteintracker.crud.UpdatePetaniActivity
...
class ResponsePetaniAdapter (val petani: List<DataItem>?): RecyclerView.Adapter<com.example.proteintracker.adapter.ResponsePetaniAdapter.PetaniHolder>(){
        ...
        override fun onBindViewHolder(holder: ResponsePetaniAdapter.PetaniHolder, position: Int) {
            ...
            popupMenu.setOnMenuItemClickListener { menuItem ->
                ...
                if (id==0){
                    ...
                    //var nama = petani?.get(position)?.nama.toString()
                    ...
                    NetworkConfig().getService()
                        ...
                        override fun onFailure(call : Call<ResponseAddPetani?>, t: Throwable) {
                            ...
                            override fun onResponse ( call: Call<ResponseAddPetani?>, response: Response<ResponseAddPetani?> ){
